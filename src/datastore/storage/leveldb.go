...
func NewLevelDB(path string, config interface{}) (Engine, error) {
	...
	// these sentinel values are here so that we can seek to the end of the keyspace and have the iterator still be valid.
	// this is for the series that is at either end of the keyspace.
	db.Put(wopts, []byte{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}, []byte{})
	db.Put(wopts, []byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}, []byte{})
